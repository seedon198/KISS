...
|---------------|-----------------|-----------------|---------|----------------|-----------|--------------|-----------|
| **MCU** | Raspberry Pi Pico W | RP2040 + CYW43439 Wi-Fi module | 1 | $6.00 | $6.00 | Official distributors | Required for Wi-Fi functionality |
...
| **Component** | **Part Number** | **Description** | **Qty** | **Unit Price** | **Total** | **Supplier** | **Notes** |
|---------------|-----------------|-----------------|---------|----------------|-----------|--------------|-----------|
| **Display** | SSD1306 240×64 | Ultra-wide banner OLED display | 1 | $12.00 | $12.00 | Adafruit, SparkFun | I2C interface required |
| **Display Connector** | JST SH 1.0mm 4-pin | Micro connector for display | 1 | $0.25 | $0.25 | JST, generic | SDA, SCL, VCC, GND |
...
| **Component** | **Part Number** | **Description** | **Qty** | **Unit Price** | **Total** | **Supplier** | **Notes** |
|---------------|-----------------|-----------------|---------|----------------|-----------|--------------|-----------|
| **Joystick** | Alps SKQUCAA010 | 5-way tactile joystick | 1 | $3.50 | $3.50 | Alps, Digi-Key | Up/Down/Left/Right/Press |
| **Back Button** | B3F-1000 | 6mm tactile button | 1 | $0.15 | $0.15 | Omron, generic | Panel mount style |
...
| **Charging IC** | MCP73871-2CCI/ML | Li-ion battery charger | 1 | $1.50 | $1.50 | Microchip | Power path management |
| **USB-C Connector** | USB4085-GF-A | USB-C receptacle | 1 | $1.20 | $1.20 | GCT, Amphenol | Power delivery capable |
...
| **Component** | **Part Number** | **Description** | **Qty** | **Unit Price** | **Total** | **Supplier** | **Notes** |
|---------------|-----------------|-----------------|---------|----------------|-----------|--------------|-----------|
| **3.3V LDO** | AMS1117-3.3 | 1A low dropout regulator | 1 | $0.30 | $0.30 | AMS, generic | SOT-223 package |
| **1.8V LDO** | LP2985-18DBVR | 150mA low noise LDO | 1 | $0.45 | $0.45 | Texas Instruments | For 1.8V target support |
| **5V Boost** | TPS61023DRLR | 5V boost converter | 1 | $1.80 | $1.80 | Texas Instruments | For 5V target support |
...
| **ESD Protection** | TPD2E007DRLR | Dual ESD diode array | 4 | $0.35 | $1.40 | Texas Instruments | Protect all JTAG lines |
...
| **Component** | **Part Number** | **Description** | **Qty** | **Unit Price** | **Total** | **Supplier** | **Notes** |
|---------------|-----------------|-----------------|---------|----------------|-----------|--------------|-----------|
| **MicroSD Slot** | DM3AT-SF-PEJM5 | Push-push microSD socket | 1 | $1.20 | $1.20 | Hirose | Card detect pin |
...
| **Component** | **Part Number** | **Description** | **Qty** | **Unit Price** | **Total** | **Supplier** | **Notes** |
|---------------|-----------------|-----------------|---------|----------------|-----------|--------------|-----------|
| **Ferrite Beads** | BLM18KG471TN1D | 470Ω @ 100MHz | 10 | $0.10 | $1.00 | Murata | Power line filtering |
| **TVS Diodes** | CDSOT23-SM712 | 7V bidirectional TVS | 6 | $0.25 | $1.50 | Bourns | USB and signal protection |
